...
/**
 * Given a 2D matrix which contains 0Õs and 1Õs. Given two points of matrix
 * whose value is 1. Find the path(with only 1Õs) between the given points
...
public class FindThePath {
	public static void main(String args[]) {
		...
		FindThePath findPath = new FindThePath();
		findPath.printShortestPath(array, 6, 0, 0, 3);
	}

	public void printShortestPath(int [][] array, int x1, int y1, int x2, int y2) {
		Queue<Point> heap = new PriorityQueue<Point>();
	...
	private void visit(Point cur, int[][] array, int i, int j,
			Map<Integer, Point> map, Queue<Point> heap) {
